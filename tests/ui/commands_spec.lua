describe("neoagent commands", function()
  it("installs documented commands and opens successfully selected resources", function()
    ...
    assert.are.equal("bottom", require("neoagent").default_window():view().position)
    assert.is_true(require("neoagent").default_window():is_open())
    require("neoagent").close()
    ...
    assert.is_true(require("neoagent").default_window():view():is_open())
    ...
    assert(vim.wait(1000, function() return not require("neoagent").default():is_authenticating() end))
    ...
    assert.is_true(require("neoagent").default():is_authenticating())
