...
function M.slice(value, first, last)
  applet_expect(type(value) == "string", "text", "must be a string", 3)
  applet_expect(type(first) == "number" and first >= 0 and first % 1 == 0,
    "first", "must be a non-negative integral display column", 3)
  if last == nil then last = M.width(value) end
  applet_expect(type(last) == "number" and last >= first and last % 1 == 0,
...
function M.truncate(value, width, opts)
  applet_expect(type(value) == "string", "text", "must be a string", 3)
  applet_expect(type(width) == "number" and width >= 0 and width % 1 == 0,
  ...
  applet_expect(side == "right" or side == "left" or side == "middle",
